        ...
        <table align="center" class="blueTable">
            ...
            <c:forEach var="temSalon" items="${LISTASALON}">
                  <c:url var="linkTemp" value="ControladorAlumnos">
                    <c:param name="instruccion" value="listarxsalon"></c:param>
                  ...
                  <c:url var="linkTemp2" value="ControladorSalon">
                    <c:param name="instruccion" value="cargar"></c:param>
                    <c:param name="idsalon" value="${temSalon.idsalon}"></c:param>                
                    <c:param name="ids" value="${IDSALON}"></c:param>
                    <c:param name="idm" value="${IDMAESTRO}"></c:param>
                    <c:param name="idpuesto" value="${IDPUESTO}"></c:param>
                    <c:param name="correo" value="${CORREO}"></c:param>
                    <c:param name="cla" value="${CLAVE}"></c:param>
                </c:url>
                    <c:url var="linkTemp3" value="ControladorSalon">
                    <c:param name="instruccion" value="Eliminar"></c:param>
                    <c:param name="ids" value="${temSalon.idsalon}"></c:param>                
            ...
            <tr class="letras">
                ...
                <td> <a href="${linkTemp}">VerLista</a></td>
                <td> <a href="${linkTemp2}">Editar Salon</a></td>
                <td> <a href="${linkTemp3}">Cerrar Salon</a></td>
            </tr>
            </c:forEach>
        </table>
        <form name="form2" method="post" action="ControladorMaestro"> 
            <input type="hidden" name="instruccion" value="ListaMaestros">
                    ...
                    <input class="boton" type="submit" name="envio" id="envio" value="NUEVO SALON"> 
